...
{
    public class AppearanceGame : GameBase
    {
        private float _hoverProgress;
        private DateTime? _hoverStartTime;

        public AppearanceGame(int screenWidth, int screenHeight) : base(screenWidth, screenHeight)
        {
            CreateInterface();
        }
        ...
        public override void DrawInterface(Mat frame)
        {
            ...
            using (Mat scoreImage = DrawingUtils.CreateTextImage($"Изменить внешность:",
                                                  new MCvScalar(255, 255, 255),
